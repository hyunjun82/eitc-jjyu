  ...
  "delivery-rider": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "배달 라이더가 사업소득(3.3%)으로 신고된다면 반기신청 대상이 아니에요. 반기신청은 근로소득자만 신청할 수 있어요. 사업소득자인 배달 라이더는 매년 5월 정기신청(5.1~6.2) 또는 기한후신청(6.3~12.1)만 이용할 수 있어요. 정기신청이 가장 유리하며, 기한후신청 시에는 산정액의 5%가 감액돼요.",
      },
    ],
    sections: [
      {
  ...
  "taxi-driver": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "법인택시 기사는 근로소득자이므로 반기신청이 가능해요. 2026년 반기 하반기분은 2026년 3월 1일부터 3월 17일까지 신청할 수 있어요. 반기신청 시 지급액은 정기신청 산정액의 35%예요. 반기신청을 하면 9월에 정기신청으로 받는 것보다 일찍 장려금을 수령할 수 있어요.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        content:
          "개인택시 기사는 매년 5월 정기신청 기간(5월 1일~6월 2일)에 국세청 홈택스나 손택스 앱으로 신청하면 돼요. 신청 전에 반드시 2025년 귀속 종합소득세 신고를 완료해야 해요. 종합소득세 신고를 하지 않으면 근로장려금 신청 자격이 없어지므로, 5월 종합소득세 신고와 근로장려금 신청을 동시에 진행하는 것이 편리해요.\n\n법인택시 기사는 반기신청도 가능해요. 2026년 반기 하반기분 신청 기간은 3월 1일부터 3월 17일까지예요. 반기 신청 시 지급액은 산정액의 35%이며, 나머지 65%는 정기신청(5월) 후 9월에 정산하여 지급해요. 급히 자금이 필요한 경우 반기신청을 활용하면 더 빨리 받을 수 있어요.\n\n신청 시에는 장려금을 수령할 본인 명의 계좌를 반드시 준비하세요. 국세청 홈택스에서 '근로장려금 신청하기'를 클릭하면 이미 입력된 소득·재산 정보를 확인하고 수정한 후 신청할 수 있어요. 소득이나 재산이 잘못 표시된 경우 직접 수정하여 정확하게 신고하는 것이 중요해요.",
      },
    ],
    datePublished: "2026-02-26",
    dateModified: "2026-02-26",
  ...
  freelancer: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "사업소득(3.3%)이 있는 프리랜서는 근로자의 연말정산과 달리 매년 5월 종합소득세 확정신고를 스스로 해야 해요. 3.3% 원천징수는 세금을 미리 납부한 것이지 최종 정산이 아니기 때문이에요. 종합소득세 신고를 하지 않으면 근로장려금 신청 자격 자체가 박탈되므로, 반드시 정기신청(5월 1일~6월 2일) 이전에 종합소득세 신고를 완료해야 해요.",
      },
      {
  ...
  clergy: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "어느 것이 유리한지는 개인의 소득 수준과 상황에 따라 달라요. 기타소득으로 신고하면 필요경비(80% 또는 60%)를 공제받아 세금이 줄어들 수 있어요. 그러나 근로소득으로 신고하면 근로소득 공제(최대 2,000만 원)와 각종 세액공제(의료비, 교육비 등)를 받을 수 있고, 반기신청(하반기분 3.1~3.17)도 가능해져요. 소득 규모와 공제 항목을 고려하여 유리한 방식을 선택하는 것이 좋아요.",
      },
      {
  ...
  "contract-worker": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "네, 계약 만료 후에도 귀속연도 내에 발생한 소득이 있다면 신청 가능해요. 근로장려금은 해당 귀속연도(2025년) 전체 소득을 기준으로 판단하므로, 2025년 중 계약직으로 일한 기간의 소득이 있다면 2026년 정기신청(5.1~6.2) 시 신청할 수 있어요. 계약 만료 후 신청하는 데 별도 제약은 없어요.",
      },
    ],
    sections: [
      {
