    ...
    sections: [
      {
        ...
        content:
          "정기신청은 매년 5월 1일부터 6월 2일까지 전년도 소득을 기준으로 근로장려금을 신청하는 방식이에요. 신청 후 국세청 심사를 거쳐 9월 말까지 장려금 전액(100%)이 한 번에 지급돼요. 정기신청은 근로소득자, 사업소득자, 종교인소득자 등 모든 소득 유형의 신청자가 이용할 수 있는 가장 기본적인 신청 방법이에요.\n\n반기신청은 당해 연도 상반기·하반기 소득을 기준으로 중간에 장려금을 미리 받는 방식이에요. 상반기분은 9월 1일~15일에 신청해 12월에 지급되고, 하반기분은 다음 해 3월 1일~17일에 신청해 6월에 지급돼요. 각 반기에 예상 장려금의 35%씩(총 70%)을 선지급받고, 나머지 30%는 다음 해 5월 정기신청을 통해 정산받아요.\n\n반기신청으로 받은 총 선지급액(35% × 2회 = 70%)이 최종 확정 장려금보다 많으면 초과분을 반환해야 하고, 적으면 나머지를 추가로 받아요. 반기신청 후에도 다음 해 5월에 정기신청을 하면 최종 정산이 이루어져요. 반기신청을 하지 않으면 정기신청으로만 처리돼요.",
        infoItems: [
          {
            type: "신청 방식",
            name: "정기신청",
            role: "5월 1일~6월 2일 신청 → 9월 지급(100%), 모든 소득 유형 가능",
          },
          {
            type: "신청 방식",
            name: "반기신청(상반기)",
          ...
          },
          {
            type: "신청 방식",
            name: "반기신청(하반기)",
            role: "3월 1일~17일 신청 → 6월 지급(35%), 근로소득자만 가능",
          },
          {
            type: "정산",
            name: "반기신청 후 정산",
      ...
      },
      {
        ...
        visual: {
          ...
          steps: [
            ...
            {
              label: "하반기 신청 (3월)",
              description: "3월 1~17일 신청 → 6월 지급 (예상액 35%)",
            },
            {
              label: "정기신청 정산 (5월)",
      ...
      },
      {
        ...
        infoItems: [
          ...
          },
          {
            type: "주의사항",
            name: "반기신청 기간",
            role: "상반기: 9월 1~15일 / 하반기: 3월 1~17일 (기간 짧음)",
          },
          {
            type: "주의사항",
            name: "초과 지급",
