...
export const spokes: Record<string, SpokeArticle> = {
  ...
  "reduction-reasons": {
    ...
    metaDescription:
      "2026년 근로장려금 감액 사유를 총정리했어요. 재산 1.4억~2.4억 50% 감액, 기한후 신청 5% 감액, 국세 체납 차감 등 실수령액에 영향을 주는 모든 요인을 확인하세요.",
    description:
    ...
    faq: [
      {
        ...
        answer:
          "주요 감액 사유는 세 가지예요. 재산이 1.4억 원~2.4억 원이면 50% 감액, 기한후 신청이면 5% 감액, 국세 체납이 있으면 체납세액이 장려금에서 차감돼요. 이 세 가지 감액 요인이 중복 적용될 수도 있어요.",
      },
      {
        question: "재산이 정확히 얼마이면 감액 없이 전액 받나요?",
        answer:
          "2026년 기준 가구원 재산 합계가 1억 4천만 원 미만이면 감액 없이 전액을 받을 수 있어요. 1억 4천만 원 이상~2억 4천만 원 미만이면 50% 감액, 2억 4천만 원 이상이면 신청 자격 자체가 없어요.",
      },
      {
        question: "기한후 신청 감액은 신청 시기에 따라 달라지나요?",
        answer:
          "아니요, 기한후 신청 감액률은 신청 시기(6월~12월 1일)에 관계없이 일률 5%가 적용돼요. 6월에 신청해도, 11월에 신청해도 동일하게 5% 감액이에요.",
      },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        content:
          "기한후 신청 감액은 정기신청 기간(5월 1일~6월 1일)을 놓치고 6월 2일~12월 1일 사이에 신청하면 산정된 장려금에서 5%가 차감되는 제도예요. 감액률은 신청 시기에 관계없이 일률 5%가 적용돼요.\n\n예를 들어 홑벌이가구 최대 장려금 285만 원이 산정된 경우, 기한후 신청 시 5% 감액이 적용되어 270만 7,500원을 받게 돼요. 재산 감액과 기한후 신청 감액이 동시에 적용되는 경우, 먼저 재산 감액(50%)이 적용된 후 여기에 기한후 신청 감액(5%)이 추가로 적용돼요.\n\n기한후 신청이라도 아예 신청을 포기하는 것보다는 훨씬 유리해요. 5% 감액이 있더라도 나머지 95%의 장려금을 수령할 수 있으니, 정기신청 기간을 놓쳤다면 반드시 기한후 신청을 활용하세요. 12월 1일을 넘기면 해당 연도 장려금을 완전히 받을 수 없어요.",
      },
      {
  ...
  "asset-reduction": {
    slug: "asset-reduction",
    categorySlug: "payment",
    title: "근로장려금 재산 1.4억~2.4억 감액 안내 | 재산 범위와 50% 적용 기준",
    h1: "근로장려금 재산 1.4억~2.4억 감액 안내 | 재산 범위와 50% 적용 기준",
    metaDescription:
      "근로장려금 재산 감액 기준을 안내해요. 재산 1.4억~2.4억 구간 50% 감액 적용 방법, 재산 범위(부동산·전세금·자동차·예금 등), 계산 예시를 확인하세요.",
    description:
      "근로장려금 재산 감액 기준인 1.4억~2.4억 구간의 50% 감액 규정과 재산 범위, 계산 방법을 상세히 안내해요.",
    heroDescription:
      "재산이 1.4억~2.4억이면 근로장려금이 절반으로 줄어요! 재산 범위와 감액 계산 방법을 확인하세요.",
    faq: [
      {
      ...
      {
        question: "재산이 1.4억에 조금 미치지 못하면 전액을 받을 수 있나요?",
        answer:
          "네, 재산 합계가 1억 4천만 원 미만이면 감액 없이 전액을 받을 수 있어요. 정확히 1억 4천만 원이 되는 시점부터 50% 감액이 적용되므로, 재산이 기준에 근접한 경우 정확한 재산 평가가 중요해요.",
      },
      {
    ...
    sections: [
      {
        ...
        content:
          "2026년 기준 근로장려금 재산 감액은 가구원 전체 재산 합계에 따라 세 구간으로 나뉘어요. 1억 4천만 원 미만이면 감액 없이 전액 지급, 1억 4천만 원~2억 4천만 원 미만이면 50% 감액, 2억 4천만 원 이상이면 신청 자격 자체가 없어요.\n\n재산 1.4억~2.4억 구간에서 50% 감액이 적용되면, 산정된 장려금의 절반만 받게 돼요. 예를 들어 단독가구 최대 165만 원이 산정되었는데 재산이 1억 8천만 원이면 실제 수령액은 82만 5천 원이에요. 홑벌이가구 285만 원 산정 시에는 142만 5천 원만 받게 돼요.\n\n50% 감액 구간은 소득 수준에 따른 지급액과 별개로 적용돼요. 즉, 소득이 낮아 장려금이 최대치보다 적게 산정되었더라도, 재산이 감액 기준을 넘으면 그 산정액의 50%만 받게 돼요. 재산이 기준에 근접하다면 재산 현황을 꼼꼼히 확인하는 것이 중요해요.",
        infoItems: [
          {
            type: "재산 기준",
            name: "1.4억 원 미만",
